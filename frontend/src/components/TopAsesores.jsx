...
function TopAsesores({ apiUrl, year, years, product, baseYear, congregacion }) {
  ...
  const { data, loading, error, retry } = useApiData(
    ...
    { year: selectedYear, limit: searchTerm ? 1000 : limit, product, compare_year: baseYear, congregacion }
  )
